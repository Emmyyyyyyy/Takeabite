    ...
    <div className="carouselWrapper">
      <div className="carouselMain">
        <div className="carouselTextArea">
            <p className="topicTag"><span><img src={foodTag} className="icon"></img></span>Hot Recipes</p>
            ...
            <div className="foodMoreInfo">
                <p className="cookingTime"><span><img src={timerIcon} className="icon"></img></span>30 Minutes</p>
                <p className="foodCatagory"><span><img src={foodCatagoryIcon} className="icon"></img></span>Chicken</p>
            </div>
